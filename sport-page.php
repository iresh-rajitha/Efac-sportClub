...
if (mysqli_num_rows($result) > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        $cover_photo='upload/sport/cover/'.$row['cover_photo'];
        $sport_photo='upload/sport/sport/'.$row['s_photo'];
    }
} else {
    echo "0 results";
}
...
<div class="page-header" data-parallax="scroll" >
    <div class="parallax round-bottom" style="background-image: url('<?php echo $cover_photo ?>')">
